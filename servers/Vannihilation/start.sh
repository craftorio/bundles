...
cd ${DIR}/config && rsync -a --exclude-from='exclude.txt' ../../../clients/Vannihilation/config/ ./ && cd -
cd ${DIR}/mods && rsync --delete -a --exclude-from='exclude.txt' ../../../clients/Vannihilation/mods/ ./ && cd -
